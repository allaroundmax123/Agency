...
Gui, Add, Groupbox, x10 y15 w870 h720  +BackGroundTrans cwhite,


;~ Buttons
Gui, Add, Button, x20 y550 w90 h40 gSad cwhite, Eigene Werbung  
Gui, Add, Button, x20 y500 w90 h40 gAusruesten cwhite, Ausruesten
Gui, Add, Button, x20 y600 w90 h40 gFest, Keybinds 
Gui, Add, Button, x20 y650 w90 h40 guseless cwhite, Letztes Update

Gui, Add, Button, x120 y550 w90 h40 gEbinds cwhite, Variablen
Gui, Add, Button, x120 y500 w90 h40 gEinstellungen cwhite, Einstellungen
Gui, Add, Button, x120 y600 w90 h40 gBTdynHotSave, Speichern
Gui, Add, Button, x120 y650 w90 h40 gconnect cwhite, Direct Connect
...
Gui, Font, Arial Bold
Gui, Add, Text, x426 y600 +BackgroundTrans cwhite, %information%
Gui, Add, Groupbox, x422 y590 w430 h100 +BackgroundTrans cwhite,
 
;~ Gui Show
Gui, Show, w900 h750, Agency Keybinder V. %keybinderVersion%
return
;}
...
Gui, 3: Add, DropDownList, x22 y137 w90 h110 vProfil1_1, ||Messer|Deagle|Shotgun|M4|MP5|Sniper|Drogen
Gui, 3: Add, DropDownList, x122 y137 w90 h110 vProfil1_2, ||Messer|Deagle|Shotgun|M4|MP5|Sniper|Drogen
Gui, 3: Add, DropDownList, x222 y137 w90 h110 vProfil1_3, ||Messer|Deagle|Shotgun|M4|MP5|Sniper|Drogen
Gui, 3: Add, DropDownList, x322 y137 w90 h110 vProfil1_4, ||Messer|Deagle|Shotgun|M4|MP5|Sniper|Drogen
Gui, 3: Add, DropDownList, x422 y137 w90 h110 vProfil1_5, ||Messer|Deagle|Shotgun|M4|MP5|Sniper|Drogen
Gui, 3: Add, DropDownList, x522 y137 w90 h110 vProfil1_6, ||Messer|Deagle|Shotgun|M4|MP5|Sniper|Drogen
Gui, 3: Add, DropDownList, x622 y137 w90 h110 vProfil1_7, ||Messer|Deagle|Shotgun|M4|MP5|Sniper|Drogen
;V2
Gui, 3: Add, DropDownList, x22 y172 w90 h110 vProfil2_1, ||Messer|Deagle|Shotgun|M4|MP5|Sniper|Drogen
Gui, 3: Add, DropDownList, x122 y172 w90 h110 vProfil2_2, ||Messer|Deagle|Shotgun|M4|MP5|Sniper|Drogen
Gui, 3: Add, DropDownList, x222 y172 w90 h110 vProfil2_3, ||Messer|Deagle|Shotgun|M4|MP5|Sniper|Drogen
Gui, 3: Add, DropDownList, x322 y172 w90 h110 vProfil2_4, ||Messer|Deagle|Shotgun|M4|MP5|Sniper|Drogen
Gui, 3: Add, DropDownList, x422 y172 w90 h110 vProfil2_5, ||Messer|Deagle|Shotgun|M4|MP5|Sniper|Drogen
Gui, 3: Add, DropDownList, x522 y172 w90 h110 vProfil2_6, ||Messer|Deagle|Shotgun|M4|MP5|Sniper|Drogen
Gui, 3: Add, DropDownList, x622 y172 w90 h110 vProfil2_7, ||Messer|Deagle|Shotgun|M4|MP5|Sniper|Drogen
...
If(InStr(line1, "hat einen Eintrag entfernt") || InStr(line2, "hat einen Eintrag entfernt") || InStr(line3, "hat einen Eintrag entfernt")){
	...
	if(InStr(line1, "hat einen Eintrag entfernt. Verbleibend:") && !InStr(line2, "hat einen Eintrag entfernt. Verbleibend:") && !InStr(line3, "hat einen Eintrag entfernt. Verbleibend:"))
	{
		...
		{
			AddChatMessage("|{01DF01}Agency{FFFFFF}| Du hast bereits " result_2 " Wanteds gehackt und bereits " FormatNumber(resultm_2) "$ verdient.")
			...
			if(result1 == 1 && resulti1 == 1){
				...
				AddChatMessage("|{01DF01}Agency{FFFFFF}| Datenbankfehler: " result1 " (Result2) ~~ " resulti1 " (Resulti2) ~~ Bitte an John_Reese wenden")
			}
...
if(contracting == -1){
	...
	AddChatMessage("Du bist an keinem Deathpickup")
	Sleep 500
	GetChatLine(0, Lines1)
	if(InStr(Lines1, "Du bist an keinem")){
		;SendChat("/offlinecontract " contracting)
		AddChatMessage("<< Hitman John_Reese hat den Auftrag ausgeführt und Jakob für 3131$ getötet (offline). >>")
		AddChatMessage("Du hast ein Verbrechen begangen ( Mord ). Zeuge: Niemand.")
		AddChatMessage("Aktuelles Wantedlevel: 10")
		Sleep 500
...
AddChatMessage("|{01DF01}Agency{FFFFFF}| Angenommen Aufträge: " FormatNumber(result_2))
AddChatMessage("|{01DF01}Agency{FFFFFF}| Ausgeführte Aufträge: " FormatNumber(result_3))
AddChatMessage("|{01DF01}Agency{FFFFFF}| Ausgeführte Contracts: " FormatNumber(result_4))
AddChatMessage("|{01DF01}Agency{FFFFFF}| Gehackte Wanteds: " FormatNumber(result_5))
AddChatMessage("|{01DF01}Agency{FFFFFF}| Einnahmen: " FormatNumber(result_6) "$")
AddChatMessage("")
AddChatMessage("|{01DF01}Agency{FFFFFF}| Monatsstats -> /agstatsmonth -- Wochenstats -> /agstatsweek")
}
return
...
errors(result_1)
if(result_1 == 1){
AddChatMessage("|{01DF01}Agency{FFFFFF}| Deine Agency Statistiken für diesen Monat")
AddChatMessage("|{01DF01}Agency{FFFFFF}| Angenommen Aufträge: " FormatNumber(result_7))
AddChatMessage("|{01DF01}Agency{FFFFFF}| Ausgeführte Aufträge: " FormatNumber(result_8))
AddChatMessage("|{01DF01}Agency{FFFFFF}| Ausgeführte Contracts: " FormatNumber(result_9))
AddChatMessage("|{01DF01}Agency{FFFFFF}| Gehackte Wanteds: " FormatNumber(result_10))
AddChatMessage("|{01DF01}Agency{FFFFFF}| Einnahmen: " FormatNumber(result_11) "$")
AddChatMessage("")
AddChatMessage("|{01DF01}Agency{FFFFFF}| Gesamte Stats -> /agstats -- Wochenstats -> /agstatsweek")
}
return
...
if(result_1 == 1){
AddChatMessage("|{01DF01}Agency{FFFFFF}| Deine Agency Statistiken für diesen Monat")
AddChatMessage("|{01DF01}Agency{FFFFFF}| Angenommen Aufträge: " FormatNumber(result_12))
AddChatMessage("|{01DF01}Agency{FFFFFF}| Ausgeführte Aufträge: " FormatNumber(result_13))
AddChatMessage("|{01DF01}Agency{FFFFFF}| Ausgeführte Contracts: " FormatNumber(result_14))
AddChatMessage("|{01DF01}Agency{FFFFFF}| Gehackte Wanteds: " FormatNumber(result_15))
AddChatMessage("|{01DF01}Agency{FFFFFF}| Einnahmen: " FormatNumber(result_16) "$")
AddChatMessage("")
AddChatMessage("|{01DF01}Agency{FFFFFF}| Gesamte Stats -> /agstats -- Monatsstats -> /agstatsmonth")
}
return
...
:?:t/findcops::
AddChatMessage("|{01DF01}Agency{FFFFFF}| Es werden nun alle Cops nacheinander 1x gesucht!")
copscount := 0
UrlDownloadToVar("https://agency.jameschans.de/keybinder/allcops.php", result)
Loop, Parse, result, ~
{
